...
public class InvalidCharacterExceptionHandler {
    @ExceptionHandler(value = com.example.linkedinSample.exception.type.InvalidCharacterException.class)
    @ResponseStatus(HttpStatus.NOT_ACCEPTABLE)
    public @ResponseBody ErrorResponse handlerInvalidCharacterException(InvalidCharacterException ex) {
